...
-(NSString *)WorkOutSubsriptionInDays:(NSString*)theProductID{
    ...
    if ([[theProductID lowercaseString] isEqualToString:@"biologyigcsecambipad1week"] ){
        
        return @"7";
        
    }

  else if ([[theProductID lowercaseString] isEqualToString:@"biologyigcsecambipad1month"] ){
        
        return @"31";
        
    }
    
    else if ([[theProductID lowercaseString] isEqualToString:@"biologyigcsecambipad3months"] ){
        
        return @"93";
        
    }
    else if ([[theProductID lowercaseString] isEqualToString:@"biologyigcsecambipad6months"] ){
        
        return @"186";
        
    }
    
    else if ([[theProductID lowercaseString] isEqualToString:@"biologyigcsecambipad9months"] ){
        
        return @"279";
        
    }
    else if ([[theProductID lowercaseString] isEqualToString:@"biologyigcsecambipad12months"] ){
